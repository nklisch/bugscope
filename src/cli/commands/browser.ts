...
export const browserOverviewCommand = defineCommand({
	...
	args: {
		...
		"time-range": { type: "string", description: "Time range as START..END (ISO timestamps)" },
		json: { type: "boolean", description: "JSON output", default: false },
		quiet: { type: "boolean", description: "Minimal output", default: false },
	},
	async run({ args }) {
...
export const browserDiffCommand = defineCommand({
	...
	args: {
		id: { type: "positional", description: "Session ID", required: true },
		from: { type: "string", description: "First moment — ISO timestamp or event ID", required: true },
		to: { type: "string", description: "Second moment — ISO timestamp or event ID", required: true },
