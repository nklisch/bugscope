...
- **Typed Error Hierarchy**: All errors extend `KrometrailError(message, code)`; domain errors add typed context fields; use `getErrorMessage(err)` for `unknown` → [error-hierarchy.md](.claude/skills/patterns/error-hierarchy.md)
